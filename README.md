...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `latest` | ![v0.107.74](https://img.shields.io/badge/-v0.107.74-6ABF4B) | ![1.24.2](https://img.shields.io/badge/-1.24.2-0077CC) | ![v0.81.1](https://img.shields.io/badge/-v0.81.1-6ABF4B) |                     Alpine Linux | Standard | Standard image running as root. Lightweight and stable. |
| `latest-wolfi` | ![v0.107.74](https://img.shields.io/badge/-v0.107.74-6ABF4B) | ![1.24.2](https://img.shields.io/badge/-1.24.2-0077CC) | ![v0.81.1](https://img.shields.io/badge/-v0.81.1-6ABF4B) |               Wolfi OS | Enhanced | Built with [Wolfi](https://github.com/wolfi-dev) for a distroless image. |
| `hardened` | ![v0.108.0-a.1287+b08e5876](https://img.shields.io/badge/-v0.108.0--a.1287+b08e5876-6ABF4B) | ![1.24.2](https://img.shields.io/badge/-1.24.2-0077CC) | ![v0.81.1-1-g97cddca](https://img.shields.io/badge/-v0.81.1--1--g97cddca-6ABF4B) |                                                  Alpine Linux | **High** | **Non-Root execution**. Runs as `adguard` user with `libcap` capabilities built from source for fewer CVEs. |
| `hardened-wolfi` | ![v0.108.0-a.1287+b08e5876](https://img.shields.io/badge/-v0.108.0--a.1287+b08e5876-6ABF4B) | ![1.24.2](https://img.shields.io/badge/-1.24.2-0077CC) | ![v0.81.1-1-g97cddca](https://img.shields.io/badge/-v0.81.1--1--g97cddca-6ABF4B) |                                                Wolfi OS | **Maximum** | Wolfi base + Non-Root execution built from source for fewer CVEs. |
<!-- VERSIONS_TABLE_END -->
