...
| Tag | Image Size | AdGuardHome | Unbound | dnsproxy | Base Image | Security Level | Description |
| :--- | :---: | :--- | :--- | :--- | :--- | :--- | :--- |
| `latest` | [![Image Size](https://img.shields.io/docker/image-size/andrianey/adguardhomedotdoh/latest?style=flat-square&logo=docker&logoColor=%23ffffff&label=%20)](https://hub.docker.com/layers/andrianey/adguardhomedotdoh/latest) | ![v0.107.74](https://img.shields.io/badge/-v0.107.74-6ABF4B) | ![1.25.0](https://img.shields.io/badge/-1.25.0-0077CC) | ![v0.81.3](https://img.shields.io/badge/-v0.81.3-6ABF4B) |  Alpine Linux | Standard | Standard image running as root. Lightweight and stable. |
| `latest-wolfi` | [![Image Size](https://img.shields.io/docker/image-size/andrianey/adguardhomedotdoh/latest-wolfi?style=flat-square&logo=docker&logoColor=%23ffffff&label=%20)](https://hub.docker.com/layers/andrianey/adguardhomedotdoh/latest-wolfi) | ![v0.107.74](https://img.shields.io/badge/-v0.107.74-6ABF4B) | ![1.25.0](https://img.shields.io/badge/-1.25.0-0077CC) | ![v0.81.3](https://img.shields.io/badge/-v0.81.3-6ABF4B) | Wolfi OS | Enhanced | Built with [Wolfi](https://github.com/wolfi-dev) for a distroless image. |
| `hardened` | [![Image Size](https://img.shields.io/docker/image-size/andrianey/adguardhomedotdoh/hardened?style=flat-square&logo=docker&logoColor=%23ffffff&label=%20)](https://hub.docker.com/layers/andrianey/adguardhomedotdoh/hardened) | ![v0.108.0-a.1295+e5c79502](https://img.shields.io/badge/-v0.108.0--a.1295+e5c79502-6ABF4B) | ![1.25.0](https://img.shields.io/badge/-1.25.0-0077CC) | ![v0.81.3](https://img.shields.io/badge/-v0.81.3-6ABF4B) | Alpine Linux | **High** | **Non-Root execution**. Runs as `adguard` user with `libcap` capabilities built from source for fewer CVEs. |
| `hardened-wolfi` | [![Image Size](https://img.shields.io/docker/image-size/andrianey/adguardhomedotdoh/hardened-wolfi?style=flat-square&logo=docker&logoColor=%23ffffff&label=%20)](https://hub.docker.com/layers/andrianey/adguardhomedotdoh/hardened-wolfi) | ![v0.108.0-a.1295+e5c79502](https://img.shields.io/badge/-v0.108.0--a.1295+e5c79502-6ABF4B) | ![1.25.0](https://img.shields.io/badge/-1.25.0-0077CC) | ![v0.81.3](https://img.shields.io/badge/-v0.81.3-6ABF4B) | Wolfi OS | **Maximum** | Wolfi base + Non-Root execution built from source for fewer CVEs. |
<!-- VERSIONS_TABLE_END -->
