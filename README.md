...
| `hardened` | ![v0.108.0-a.1295+e5c79502](https://img.shields.io/badge/-v0.108.0--a.1295+e5c79502-6ABF4B) | ![1.25.0](https://img.shields.io/badge/-1.25.0-0077CC) | ![v0.81.3](https://img.shields.io/badge/-v0.81.3-6ABF4B) |                                                        Alpine Linux | **High** | **Non-Root execution**. Runs as `adguard` user with `libcap` capabilities built from source for fewer CVEs. |
| `hardened-wolfi` | ![v0.108.0-a.1295+e5c79502](https://img.shields.io/badge/-v0.108.0--a.1295+e5c79502-6ABF4B) | ![1.25.0](https://img.shields.io/badge/-1.25.0-0077CC) | ![v0.81.3](https://img.shields.io/badge/-v0.81.3-6ABF4B) |                                                      Wolfi OS | **Maximum** | Wolfi base + Non-Root execution built from source for fewer CVEs. |
<!-- VERSIONS_TABLE_END -->
