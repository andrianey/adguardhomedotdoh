...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `latest` | ![v0.107.73](https://img.shields.io/badge/-v0.107.73-6ABF4B) | ![1.24.2](https://img.shields.io/badge/-1.24.2-0077CC) | ![v0.80.0](https://img.shields.io/badge/-v0.80.0-6ABF4B) |             Alpine Linux | Standard | Standard image running as root. Lightweight and stable. |
...
| `hardened` | ![v0.108.0-a.1259+2d49f9dc](https://img.shields.io/badge/-v0.108.0--a.1259+2d49f9dc-6ABF4B) | ![1.24.2](https://img.shields.io/badge/-1.24.2-0077CC) | ![v0.80.0-dirty](https://img.shields.io/badge/-v0.80.0--dirty-6ABF4B) |                      Alpine Linux | **High** | **Non-Root execution**. Runs as `adguard` user with `libcap` capabilities built from source for fewer CVEs. |
| `hardened-wolfi` | ![v0.108.0-a.1259+2d49f9dc](https://img.shields.io/badge/-v0.108.0--a.1259+2d49f9dc-6ABF4B) | ![1.24.2](https://img.shields.io/badge/-1.24.2-0077CC) | ![v0.80.0-dirty](https://img.shields.io/badge/-v0.80.0--dirty-6ABF4B) |                        Wolfi OS | **Maximum** | Wolfi base + Non-Root execution built from source for fewer CVEs. |
<!-- VERSIONS_TABLE_END -->
