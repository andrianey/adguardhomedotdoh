...
| `hardened` | ![v0.108.0-a.1292+c22183c6](https://img.shields.io/badge/-v0.108.0--a.1292+c22183c6-6ABF4B) | ![1.24.2](https://img.shields.io/badge/-1.24.2-0077CC) | ![v0.81.2](https://img.shields.io/badge/-v0.81.2-6ABF4B) |                                                     Alpine Linux | **High** | **Non-Root execution**. Runs as `adguard` user with `libcap` capabilities built from source for fewer CVEs. |
| `hardened-wolfi` | ![v0.108.0-a.1291+44dfffc8](https://img.shields.io/badge/-v0.108.0--a.1291+44dfffc8-6ABF4B) | ![1.24.2](https://img.shields.io/badge/-1.24.2-0077CC) | ![v0.81.2](https://img.shields.io/badge/-v0.81.2-6ABF4B) |                                                  Wolfi OS | **Maximum** | Wolfi base + Non-Root execution built from source for fewer CVEs. |
<!-- VERSIONS_TABLE_END -->
