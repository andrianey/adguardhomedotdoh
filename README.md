...
| `hardened` | ![v0.108.0-a.1290+313135d7](https://img.shields.io/badge/-v0.108.0--a.1290+313135d7-6ABF4B) | ![1.24.2](https://img.shields.io/badge/-1.24.2-0077CC) | ![v0.81.2](https://img.shields.io/badge/-v0.81.2-6ABF4B) |                                                   Alpine Linux | **High** | **Non-Root execution**. Runs as `adguard` user with `libcap` capabilities built from source for fewer CVEs. |
