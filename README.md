...
| `hardened-wolfi` | ![v0.108.0-a.1286+9e153fbd](https://img.shields.io/badge/-v0.108.0--a.1286+9e153fbd-6ABF4B) | ![1.24.2](https://img.shields.io/badge/-1.24.2-0077CC) | ![v0.81.1](https://img.shields.io/badge/-v0.81.1-6ABF4B) |                                               Wolfi OS | **Maximum** | Wolfi base + Non-Root execution built from source for fewer CVEs. |
<!-- VERSIONS_TABLE_END -->
